...
// Copyright (c) 2019 The Meraki Core developers
 ...
 *   vMerkleTree: e0028e
 */
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward, const char *psz)
{
    const char* pszTimestamp = "'Greta Thunberg effect' driving growth in carbon offsetting Fri 8 Nov 2019";
    const CScript genesisOutputScript = CScript() << ParseHex(psz) << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        // consensus.nSuperblockStartHash = uint256S("0x00000477cda1c2874efcf849b24b44c62b0b67f8bfba6971f9120d7d39765103");
        ...
        genesis = CreateGenesisBlock(1573217587, 975910, 0x1e0ffff0, 1, 50 * COIN, "04d985184cd90f77110e506249fddf37d7b836781216aecab08cb4d1fc74cb8eed674715bddfe85ffb0ec2a0ab7f7d4fa428df22f24bb9cd6edaad6a5d22e41b4f");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000003d1edd3bd1d5c485d34c19bd1888d5ff78bc4cf57062975aa043f7c405"));
        assert(genesis.hashMerkleRoot == uint256S("0x467b716c61af7b80a816d9f75f2606144dc56d4224fb38b1dd46649b1a2db33f"));

        vSeeds.push_back(CDNSSeedData("meraki.cash", "dns.meraki.cash"));

        // Dash addresses start with 'm'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,110);
        // Dash script addresses start with 'n'
        ...
        vSporkAddresses = {"meFd8vx1qUjzzXDxFayXM6YSvjPmthNaqS"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1573217587, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockStartBlock = 10; // NOTE: Should satisfy nSuperblockStartBlock > nBudgetPaymentsStartBlock
        consensus.nSuperblockStartHash = uint256(); // do not check this on testnet
        ...
        vAlertPubKey = ParseHex("045869abc3fc34db5cb60e3c4d56335cf7eb348ef507223f593f3e57942111d4bca64abbc21bacab878d897db9166386fab12a66dda440973c4eae839dd7cd25a3");
        nDefaultPort = 2999;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1573217677, 31583, 0x1e0ffff0, 1, 50 * COIN, "045869abc3fc34db5cb60e3c4d56335cf7eb348ef507223f593f3e57942111d4bca64abbc21bacab878d897db9166386fab12a66dda440973c4eae839dd7cd25a3");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000006aa6738f56e02859c97ed1256467c29324c0055dc5355bc02d295b88f46"));
        assert(genesis.hashMerkleRoot == uint256S("0x1ee6f9ae4f72721eb4bb58e5adfd2dcf42c20b4a4fd0195b457dedd15adda97e"));
        ...
        chainTxData = ChainTxData{
            1570712525, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams() {
        ...
        vAlertPubKey = ParseHex("047e98f9966b65607a563f328048b6cab7a729adc6fecf000b1c7d77eff7af2782a6dcbec282aafb7973518d57ae03471bf2debe8a2954373bd3cf5a817bf4ff0a");
        nDefaultPort = 2999;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1573217704, 1183791, 0x1e0ffff0, 1, 50 * COIN, "047e98f9966b65607a563f328048b6cab7a729adc6fecf000b1c7d77eff7af2782a6dcbec282aafb7973518d57ae03471bf2debe8a2954373bd3cf5a817bf4ff0a");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000f1b8031a14d9623237750aa3635a14befe880f4cf79bd51047f724cd345"));
        assert(genesis.hashMerkleRoot == uint256S("0x636f4c6a0cb90196717856dca9c1b90bb9c5f276e0c21799750cddb9775c0967"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x00000f1b8031a14d9623237750aa3635a14befe880f4cf79bd51047f724cd345"))
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1573217738, 124088, 0x1e0ffff0, 1, 50 * COIN, "04c2a72a5db66c6b4cc7353cddd7805b79278b4690f7241861093c1b0b44d90754efd9870581223cf29591f0a112cabc2712b6849b63c1fe2a45900d3ae1c958f8");
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000ab312876e4016fa9d06937de325f0be0437ebfaf074baca56fe66282349"));
        assert(genesis.hashMerkleRoot == uint256S("0x989dd481fe5ae3b0d1fade9c2f7ccc69d638ae3dbb4a35a3272fcfc4692cbd01"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x00000ab312876e4016fa9d06937de325f0be0437ebfaf074baca56fe66282349"))
        };
