    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  meraki-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Meraki in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 MERAKI, 0.01 MERAKI, 0.1 MERAKI, 1 MERAKI and 10 MERAKI -- sort of like the paper money you use every day.</li> \
