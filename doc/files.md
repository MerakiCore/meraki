...
* meraki.conf: contains configuration settings for merakid or meraki-qt
* merakid.pid: stores the process id of merakid while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by merakid or meraki-qt
