Cross-compiliation of Meraki core
===============================

Meraki core can be cross-compiled on Linux to all other supported host systems. This is done by changing
